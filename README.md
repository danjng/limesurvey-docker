# Lime Survey Container Prototype

## What this is

This Docker project is for standing up a demo instance of the Lime Survey application. Details on the implementation can be found in the `Dockerfile` and `docker-compose.yml`.
